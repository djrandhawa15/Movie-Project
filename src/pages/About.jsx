...
// About component displaying information about the project and creators
const About = () => {
  return (
    <section className="about-container">
      ...
      <article className="about-info">
        <p>
          CINE HUB is an innovative movie database project designed to provide
          users with a comprehensive and immersive movie experience. CINE HUB
          offers a vast collection of information about movies, TV shows,
          actors, and more.
        </p>
        <br />
        <p>Created by:</p>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a
                  href="https://www.linkedin.com/in/simranwarraich/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faLinkedin} className="icon-large" />
                ...
                <a
                  href="https://github.com/Simran1997161"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faGithub} className="icon-large" />
            ...
            <tr>
              ...
              <td>
                ...
                <a
                  href="https://www.linkedin.com/in/mudarres-amin-090784194/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <FontAwesomeIcon icon={faLinkedin} className="icon-large" />
